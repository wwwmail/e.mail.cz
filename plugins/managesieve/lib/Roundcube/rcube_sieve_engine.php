...
$select = new html_select(array('name' => '_copy', 'id' => '_copy'));
    ...
    function filter_form($attrib)
    {
        ...
        if ($compact) {
            ...
            $out .= sprintf("\n" . '<div class="form-group row">'
                ...
                . '<div class="col-sm-8"><div class="custom-select">%s</div></div></div>',
    ...
    function rule_div($fid, $id, $div = true, $compact = false)
    {
        ...
        $aout = html::div('custom-select', $select_header->show($test));
        ...
        $tout .= "\n" . html::div('custom-select', $select_size_item->show($sizeitem));
        $tout .= '</div>';
        $tout .= '</div>';
        ...
        $mout .= html::div('custom-select',$select_mod->show($rule['test']));
        $mout .= '</div>';
        ...
        $mout .= html::div('custom-select', $select_type->show($rule['part']));
        $mout .= '</div>';
        ...
        $mout .= html::div('custom-select', $select_comp->show($rule['comparator']));
        $mout .= '</div>';
        ...
        if (in_array('mime', $this->exts)) {
            ...
            $mout .= html::div('custom-select', $select_mime_part->show(!empty($rule['mime-anychild']) ? 'anychild' : ''));
            $mout .= '</div>';
            ...
            $mout .= html::div('custom-select', $select_mime->show($mime_type));
    ...
    function action_div($fid, $id, $div=true)
    {
        ...
        $out .= html::div('custom-select custom-select-action_type', $select_action->show($select_type));
        $out .= '</td>';
        ...
        $out .= html::div('custom-select', $select->show($mailbox));
        $out .= '</td>';
